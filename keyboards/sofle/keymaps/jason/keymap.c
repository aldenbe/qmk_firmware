...
#define KC_RWORD LCTL(KC_DOWN)
#define KC_UWORD (MOD_LCTL | KC_UP)
#define KC_DWORD (MOD_LCTL | KC_DOWN)
#define JA_C_DL LCTL_T(KC_DEL)
#define JA_S_BS LSFT_T(KC_BSPC)
#define JA_S_SP RSFT_T(KC_SPC)
#define JA_S_EN RSFT_T(KC_ENT)
...
#define JA_NBSPC LT(_LOWER, KC_BSPC)
#define JA_CDEL LCTL_T(KC_DEL)
#define JA_ALEN LALT_T(KC_ENT)
#define KC_NUMI LT(_LOWER, KC_MINS)
 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  KC_PGUP,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,   KC_K,    KC_L,    KC_QUOT, KC_SCLN,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  KC_PGDN, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MUTE,  KC_D_MUTE,KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH,   KC_BSLS,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
            KC_LBRC, KC_RBRC,JA_STAB ,JA_NBSPC ,JA_CDEL,           JA_ALEN ,KC_SPC   ,KC_NUMI,KC_LGUI, KC_SCLN
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
[_LOWER] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  RGB_TOG,  KC_NO,  KC_LALT ,KC_LCTL ,KC_LSFT ,KC_TAB,                   KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT, KC_NO,   KC_DEL,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  RGB_MOD,  KC_NO,  KC_NO,   ALTAB,   KC_WH_D, KC_PGDN,_______,   _______,KC_HOME,KC_END  ,KC_PGUP ,KC_PGDN ,KC_0,KC_BSPC,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 _______, _______, _______, _______,  _______,   JA_ALENT, KC_END, _______, _______, _______
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
  ...
  _______,  KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_CIRC, KC_AMPR,KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                   _______, _______, _______, KC_BSPC, KC_END,    _______, _______, _______, _______, _______
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  XXXXXXX,   XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    KC_ASDN, KC_ASUP, KC_ASRP, KC_ASON, KC_ASOFF, KC_ASTG,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
...
void keyboard_post_init_user(void) {
	...
	rgblight_mode(8);// haven't found a way to set this in a more useful way
