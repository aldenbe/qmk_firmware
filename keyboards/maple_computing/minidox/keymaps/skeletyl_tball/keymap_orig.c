...
[_DVORAK] = LAYOUT ( \
  ...
  CTLSCLN, ALTQ,    GUIJ,    KC_K,    KC_X,       KC_B,    KC_M,    GUIW,    ALTV,    RCTLZED, \
                    KC_BSPC,LOWER,  KC_LSFT,    KC_ENT,  KC_SPC,  RAISE                      \
),
...
[_QWERTY] = LAYOUT (
  ...
  LCTLZED, ALTX,    GUIC,    KC_V,    KC_B,       KC_N,    KC_M,    GUICOMM, ALTDOT,  CTLSLSH,
                    JA_SBSPC,_LOWER,  KC_LSFT,    KC_ENT,  KC_SPC,  RAISE
),
...
[_ADJUST] =  LAYOUT ( \
  ...
  _______, _QWERTY,  _COLEMAK, _DVORAK,  _______,    RESET,   _______, _______, _______, _______, \
